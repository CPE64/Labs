...
\section{Lab Procedure}
  ...
  \subsection{Requirements of the 595 register}

  \subsection{Interaction with External Shift register}

  \subsection{Hard Mode: Modulation of brightness using shift register}
